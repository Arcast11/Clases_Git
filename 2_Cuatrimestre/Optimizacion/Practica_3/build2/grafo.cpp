...
void GRAFO::dfs_cc(unsigned i, vector<bool>& visitado) {
  // Este recorrido esta� hecho adhoc para mostrar el ritmo de nodos
  // visitados, para su uso en la construccion de Componentes Conexas
...
void GRAFO::dfs_cfc(unsigned i, vector<bool>& visitado) {
  // Este recorrido esta� hecho adhoc para mostrar el ritmo de nodos
  // visitados, para su uso en la construccion de Componentes fuertemente
  // Conexas
  visitado[i] = true;  // visitamos el nodo i + 1
  cout << i + 1;
